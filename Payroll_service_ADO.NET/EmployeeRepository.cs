...
namespace Payroll_service_ADO.NET
{
    ...
    {  /* UC1:- Ability to create a payroll service database and have C# program connect to database.
        ...
        */
        ...
        public static string connectionString = @"Data Source=.;Initial Catalog=Payroll_Service;Integrated Security=True";//Specifying the connection string from the sql server connection.
